<?php
/**
 * WP_Framework Classes Models Custom Post
 *
 * @version 0.0.1
 ...
 */
class Custom_Post implements \WP_Framework\Interfaces\Loader, \WP_Framework\Interfaces\Uninstall {

	use \WP_Framework\Traits\Loader, \WP_Framework\Traits\Uninstall;

	/**
	 * @var \WP_Framework\Interfaces\Helper\Custom_Post[] $_custom_posts
	 */
	...
	protected function get_instanceof() {
		return '\WP_Framework\Interfaces\Helper\Custom_Post';
	}
	...
	public function get_custom_posts() {
		if ( ! isset( $this->_custom_posts ) ) {
			...
			$post_types                 = array_map( function ( $d ) {
				/** @var \WP_Framework\Interfaces\Helper\Custom_Post $d */
	 ...
	 * @param string $slug
	 *
	 * @return \WP_Framework\Interfaces\Helper\Custom_Post|null
	 */
