<?php
/**
 * WP_Framework Classes Models Mail
 *
 * @version 0.0.1
 ...
 */
class Mail implements \WP_Framework\Interfaces\Singleton, \WP_Framework\Interfaces\Hook, \WP_Framework\Interfaces\Presenter {
