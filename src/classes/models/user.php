<?php
/**
 * WP_Framework Classes Models User
 *
 * @version 0.0.1
 ...
 */
class User implements \WP_Framework\Interfaces\Singleton, \WP_Framework\Interfaces\Hook, \WP_Framework\Interfaces\Uninstall {
