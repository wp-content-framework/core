<?php
/**
 * WP_Framework Classes Models Db
 *
 * @version 0.0.1
 ...
 */
class Db implements \WP_Framework\Interfaces\Singleton, \WP_Framework\Interfaces\Hook, \WP_Framework\Interfaces\Uninstall {
	 ...
	 * @return array
	 */
	private function get_field_data( $k, array $columns ) {
		$table = null;
	 ...
	 * @return string
	 */
	private function get_field_name( $k, array $columns ) {
	 ...
	 * @return array
	 */
	private function build_fields( array $fields, array $columns ) {
		if ( ! isset( $fields ) ) {
			$fields = [ '*' ];
		}
		if ( is_string( $fields ) ) {
	 ...
	 * @return string
	 */
	private function build_group_by( array $group_by, array $columns ) {
		$sql = '';
		if ( ! empty( $group_by ) ) {
			$items = [];
	 ...
	 * @return string
	 */
	private function build_order_by( array $order_by, array $columns ) {
		$sql = '';
		if ( ! empty( $order_by ) ) {
			$items = [];
	 ...
	 * @return string
	 */
	private function build_join( array $join ) {
		$sql = '';
		if ( ! empty( $join ) ) {
			$items = [];
	 ...
	 * @return string|false
	 */
	public function get_select_sql( $tables, array $where = null, array $fields = null, $limit = null, $offset = null, array $order_by = null, array $group_by = null, $for_update = false ) {
		$as = null;
		if ( is_array( $tables ) ) {
			if ( empty( $tables ) ) {
				return false;
	 ...
	 */
	public function select( $tables, array $where = null, $fields = null, $limit = null, $offset = null, array $order_by = null, array $group_by = null, $output = null, $for_update = false ) {
	 ...
	 * @return array|bool|null
	 */
	public function select_row( $tables, array $where = null, $fields = null, $offset = null, array $order_by = null, array $group_by = null, $output = null, $for_update = false ) {
	 ...
	 * @return int
	 */
	public function select_count( $table, $field = '*', array $where = null, $limit = null, $offset = null, array $order_by = null, array $group_by = null, $for_update = false ) {
