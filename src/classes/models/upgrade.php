<?php
/**
 * WP_Framework Classes Models Upgrade
 *
 * @version 0.0.1
 ...
 */
class Upgrade implements \WP_Framework\Interfaces\Loader {
	...
	private function upgrade() {
		...
		try {
			...
			foreach ( $this->get_class_list() as $class ) {
				/** @var \WP_Framework\Interfaces\Upgrade $class */
	...
	protected function get_instanceof() {
		return '\WP_Framework\Interfaces\Upgrade';
	}
