<?php
/**
 * WP_Framework Interfaces Helper Custom Post
 *
 * @version 0.0.1
 ...
 */
interface Custom_Post extends \WP_Framework\Interfaces\Singleton, \WP_Framework\Interfaces\Hook, \WP_Framework\Interfaces\Presenter, Data_Helper, Validate {
	 ...
	 * @return array
	 */
	public function get_post_type_args( array $capabilities = null );
	 ...
	 * @return array
	 */
	public function list_data( $is_valid = true, $per_page = null, $page = 1, array $where = null, array $orderby = null );
	 ...
	 * @return array
	 */
	public function validate_input( array $post_array = null );
