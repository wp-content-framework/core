<?php
/**
 * WP_Framework Traits Helper Custom Post
 *
 * @version 0.0.1
...
trait Custom_Post {
	 ...
	 * @return mixed
	 */
	protected function get_post_field( $key, $default = null, array $post_array = null, array $setting = [], $filter = true ) {
		if ( isset( $post_array ) ) {
	...
	protected function filter_post_field(
		/** @noinspection PhpUnusedParameterInspection */
		$key, $value, $default, array $post_array
	) {
		return $value;
	}
